...
public class JavaScriptParser extends JavaScriptParserBase {
	...
	public final CatchProductionContext catchProduction() throws RecognitionException {
		...
		try {
			...
			if (_la==OpenParen) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==OpenBracket || _la==OpenBrace || ((((_la - 98)) & ~0x3f) == 0 && ((1L << (_la - 98)) & 2116099L) != 0)) {
					{
					setState(518);
					assignable();
					}
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 262688L) != 0) || ((((_la - 98)) & ~0x3f) == 0 && ((1L << (_la - 98)) & 2116099L) != 0)) {
				{
				setState(541);
				formalParameterList();
				}
	...
	private SingleExpressionContext singleExpression(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 98)) & ~0x3f) == 0 && ((1L << (_la - 98)) & 2116099L) != 0)) {
					{
					setState(785);
					identifier();
					}
